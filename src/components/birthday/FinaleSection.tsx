      ...
      <div className="mx-auto w-full max-w-6xl text-center">
        {!opened ? (
          <div className="animate-bloom">
            ...
            <h2 className="mt-6 font-display text-[2.25rem] sm:text-[5rem] lg:text-[6rem] leading-[0.95] text-foreground tracking-tight">
          ...
          <div className="space-y-20">
            <header className="animate-fade-up">
              ...
              <h2 className="mt-4 font-display text-[2.25rem] sm:text-[5rem] lg:text-[6rem] leading-[0.95] text-foreground tracking-tight">
                Everything I love,
            ...
            <section className="pt-12 animate-fade-up" style={{ animationDelay: "0.4s" }}>
              <div className="relative mx-auto max-w-2xl">
                ...
                <div className="relative glass-deep rounded-[2rem] p-12 shadow-deep ring-glow">
                  ...
                  <p className="font-script text-4xl sm:text-6xl sm:text-7xl text-shimmer leading-none">happy birthday,</p>
                  <p className="mt-3 font-display text-2xl sm:text-4xl sm:text-5xl text-foreground italic font-light">my forever favorite.</p>
